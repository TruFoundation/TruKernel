...
# The kernel should allow the HOST application to define its name
# For now, we default to 'TruKernel', but this should ideally be passed in via __init__
KERNEL_NAME = os.getenv("TRUKERNEL_APP_NAME", "TruKernel")
KERNEL_AUTHOR = os.getenv("TRUKERNEL_APP_AUTHOR", "TruFoundation")

DATA_DIR = Path(user_data_dir(KERNEL_NAME, KERNEL_AUTHOR))
DATA_DIR.mkdir(parents=True, exist_ok=True)

# 'kernel_state.db' is for internal kernel usage.
DB_PATH = DATA_DIR / "kernel_state.db"
